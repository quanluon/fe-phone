...
export const PromoBanner = () => {
  return (
    <section className="relative overflow-hidden rounded-[2rem] bg-slate-950 px-6 py-6 text-white shadow-strong sm:px-8">
      ...
      <div className="relative z-10 grid gap-4 sm:grid-cols-[1.2fr_0.8fr] sm:items-end">
